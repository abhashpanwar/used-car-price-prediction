<div class="z ab ac ae af gx ah ai">
    <div>
        <h1 id="88c4" class="gy gz bx ha b hb hc hd he hf hg hh hi hj hk hl hm hn ho hp hq ap">Used Car Price Prediction using Machine Learning</h1>
    </div>
    <h2 id="13b8" class="hr gz bx bw gm hs ht hu hv hw hx hy hz ia ib ic id ie if ig ih cb">Data Cleaning, Data Preprocessing, 8 Different ML Models and Some Insights from Data</h2>
    <div class="ii">
        <div class="n fg ij ik il">
            <div class="o n">
                <div><a rel="noopener" href="/@abhashpanwar?source=post_page-----e3be02d977b2----------------------"><img alt="Panwar Abhash Anil" class="r dz im in" src="https://miro.medium.com/fit/c/96/96/1*Cq18A85I2lyLHupAxoZuvQ.jpeg" width="48" height="48"></a></div>
                <div
                    class="io ai r">
                    <div class="n">
                        <div style="flex:1"><span class="bw b bx by bz ca r ap q"><div class="ip n o iq"><span class="bw gm da by av ir cv as at au ap"><a class="cl cm bg bh bi bj bk bl bm bn fm bq cp cq" rel="noopener" href="/@abhashpanwar?source=post_page-----e3be02d977b2----------------------">Panwar Abhash Anil</a></span>
                            <div
                                class="ft r bv h"></div>
                    </div>
                    </span>
            </div>
        </div><span class="bw b bx by bz ca r cb cc"><span class="bw gm da by av ir cv as at au cb"><div><a class="cl cm bg bh bi bj bk bl bm bn fm bq cp cq" rel="noopener" href="/@abhashpanwar/used-car-price-prediction-using-machine-learning-e3be02d977b2?source=post_page-----e3be02d977b2----------------------">Aug 3</a> <!-- -->·<!-- --> <!-- -->11<!-- --> min read<span style="padding-left:4px"><svg class="star-15px_svg__svgIcon-use" width="15" height="15" viewBox="0 0 15 15" style="margin-top:-2px"><path d="M7.44 2.32c.03-.1.09-.1.12 0l1.2 3.53a.29.29 0 0 0 .26.2h3.88c.11 0 .13.04.04.1L9.8 8.33a.27.27 0 0 0-.1.29l1.2 3.53c.03.1-.01.13-.1.07l-3.14-2.18a.3.3 0 0 0-.32 0L4.2 12.22c-.1.06-.14.03-.1-.07l1.2-3.53a.27.27 0 0 0-.1-.3L2.06 6.16c-.1-.06-.07-.12.03-.12h3.89a.29.29 0 0 0 .26-.19l1.2-3.52z"></path></svg></span></div>
    </span>
    </span>
</div>
</div>
<div class="n is it iu iv iw ix iy iz y">
    <div class="n o">
        <div class="ja r bv"><button class="cl cm bg bh bi bj bk bl bm bn cn co bq cp cq"><svg width="29" height="29" class="cc"><path d="M22.05 7.54a4.47 4.47 0 0 0-3.3-1.46 4.53 4.53 0 0 0-4.53 4.53c0 .35.04.7.08 1.05A12.9 12.9 0 0 1 5 6.89a5.1 5.1 0 0 0-.65 2.26c.03 1.6.83 2.99 2.02 3.79a4.3 4.3 0 0 1-2.02-.57v.08a4.55 4.55 0 0 0 3.63 4.44c-.4.08-.8.13-1.21.16l-.81-.08a4.54 4.54 0 0 0 4.2 3.15 9.56 9.56 0 0 1-5.66 1.94l-1.05-.08c2 1.27 4.38 2.02 6.94 2.02 8.3 0 12.86-6.9 12.84-12.85.02-.24 0-.43 0-.65a8.68 8.68 0 0 0 2.26-2.34c-.82.38-1.7.62-2.6.72a4.37 4.37 0 0 0 1.95-2.51c-.84.53-1.81.9-2.83 1.13z"></path></svg></button></div>
        <div
            class="ja r bv"><button class="cl cm bg bh bi bj bk bl bm bn cn co bq cp cq"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" class="cc"><path d="M5 6.36C5 5.61 5.63 5 6.4 5h16.2c.77 0 1.4.61 1.4 1.36v16.28c0 .75-.63 1.36-1.4 1.36H6.4c-.77 0-1.4-.6-1.4-1.36V6.36z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M10.76 20.9v-8.57H7.89v8.58h2.87zm-1.44-9.75c1 0 1.63-.65 1.63-1.48-.02-.84-.62-1.48-1.6-1.48-.99 0-1.63.64-1.63 1.48 0 .83.62 1.48 1.59 1.48h.01zM12.35 20.9h2.87v-4.79c0-.25.02-.5.1-.7.2-.5.67-1.04 1.46-1.04 1.04 0 1.46.8 1.46 1.95v4.59h2.87v-4.92c0-2.64-1.42-3.87-3.3-3.87-1.55 0-2.23.86-2.61 1.45h.02v-1.24h-2.87c.04.8 0 8.58 0 8.58z" fill="#fff"></path></svg></button></div>
    <div
        class="ja r bv"><button class="cl cm bg bh bi bj bk bl bm bn cn co bq cp cq"><svg width="29" height="29" class="cc"><path d="M23.2 5H5.8a.8.8 0 0 0-.8.8V23.2c0 .44.35.8.8.8h9.3v-7.13h-2.38V13.9h2.38v-2.38c0-2.45 1.55-3.66 3.74-3.66 1.05 0 1.95.08 2.2.11v2.57h-1.5c-1.2 0-1.48.57-1.48 1.4v1.96h2.97l-.6 2.97h-2.37l.05 7.12h5.1a.8.8 0 0 0 .79-.8V5.8a.8.8 0 0 0-.8-.79"></path></svg></button></div>
<div
    class="jb r">
    <div>
        <div class="ce">
            <div>
                <div class="cg" role="tooltip" aria-hidden="false" aria-describedby="1" aria-labelledby="1"><button class="cl cm bg bh bi bj bk bl bm bn cn co bq cp cq"><svg width="25" height="25" viewBox="0 0 25 25"><path d="M19 6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v14.66h.01c.01.1.05.2.12.28a.5.5 0 0 0 .7.03l5.67-4.12 5.66 4.13a.5.5 0 0 0 .71-.03.5.5 0 0 0 .12-.29H19V6zm-6.84 9.97L7 19.64V6a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v13.64l-5.16-3.67a.49.49 0 0 0-.68 0z" fill-rule="evenodd"></path></svg></button></div>
            </div>
        </div>
    </div>
    </div>
    <div class="jc r am">
        <div class="cg" aria-hidden="false">
            <div class="cg" aria-hidden="false">
                <div class="r bv"><button class="cl cm bg bh bi bj bk bl bm bn cn co bq cp cq"><svg width="25" height="25" viewBox="-480.5 272.5 21 21" class="q"><path d="M-463 284.6c.9 0 1.6-.7 1.6-1.6s-.7-1.6-1.6-1.6-1.6.7-1.6 1.6.7 1.6 1.6 1.6zm0 .9c-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5 2.5 1.1 2.5 2.5-1.1 2.5-2.5 2.5zm-7-.9c.9 0 1.6-.7 1.6-1.6s-.7-1.6-1.6-1.6-1.6.7-1.6 1.6.7 1.6 1.6 1.6zm0 .9c-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5 2.5 1.1 2.5 2.5-1.1 2.5-2.5 2.5zm-7-.9c.9 0 1.6-.7 1.6-1.6s-.7-1.6-1.6-1.6-1.6.7-1.6 1.6.7 1.6 1.6 1.6zm0 .9c-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5 2.5 1.1 2.5 2.5-1.1 2.5-2.5 2.5z"></path></svg></button></div>
            </div>
        </div>
    </div>
    </div>
    ...
    <figure class="je jf jg jh ji jj ge gf paragraph-image">
        <div class="ge gf jd">
            <div class="jn r dc fs">
                <div class="jo jp r">
                    <div class="db jk s t u eg ai av jl jm"><img alt="Image for post" class="s t u eg ai jq jr bc vu" src="https://miro.medium.com/max/60/1*ZOcUPrSXLYucFxppoI-dYg.png?q=20" width="647" height="282"></div><img alt="Image for post" class="eu ve s t u eg ai jt" width="647" height="282"
                        src="https://miro.medium.com/max/647/1*ZOcUPrSXLYucFxppoI-dYg.png" srcset="https://miro.medium.com/max/276/1*ZOcUPrSXLYucFxppoI-dYg.png 276w, https://miro.medium.com/max/552/1*ZOcUPrSXLYucFxppoI-dYg.png 552w, https://miro.medium.com/max/640/1*ZOcUPrSXLYucFxppoI-dYg.png 640w, https://miro.medium.com/max/647/1*ZOcUPrSXLYucFxppoI-dYg.png 647w"
                        sizes="647px"><noscript><img alt="Image for post" class="s t u eg ai" src="https://miro.medium.com/max/1294/1*ZOcUPrSXLYucFxppoI-dYg.png" width="647" height="282" srcSet="https://miro.medium.com/max/552/1*ZOcUPrSXLYucFxppoI-dYg.png 276w, https://miro.medium.com/max/1104/1*ZOcUPrSXLYucFxppoI-dYg.png 552w, https://miro.medium.com/max/1280/1*ZOcUPrSXLYucFxppoI-dYg.png 640w, https://miro.medium.com/max/1294/1*ZOcUPrSXLYucFxppoI-dYg.png 647w" sizes="647px"/></noscript></div>
            </div>
        </div>
    </figure>
    <blockquote class="ju jv jw">
        <p id="7ce1" class="jx jy jz ka b hs kb kc hv kd ke kf kg ia kh ki id kj kk ig kl gs ap" data-selectable-paragraph=""><span class="vy dc vz jp"><span class="r"><span class="s u t wa wb pq vc"><button class="cl cc bg bh bi bj bk bl bm cy bn"><svg width="19" height="19" aria-label="View 3 Private Notes"><path d="M14.78 8.07a8.68 8.68 0 0 0-.43-1.38.48.48 0 0 0-.58-.27l-3.12.77V4.03c0-.24-.2-.48-.43-.5a7.23 7.23 0 0 0-1.38 0c-.24.02-.43.26-.43.5V7.2L5.3 6.41a.48.48 0 0 0-.58.27c-.18.45-.33.92-.43 1.39-.05.24.1.5.32.58l3.06.75-1.98 2.96c-.14.2-.13.5.04.67.34.33.7.63 1.1.9.2.13.48.07.62-.12l2.1-3.12 2.08 3.12c.15.19.43.25.63.11a7.7 7.7 0 0 0 1.1-.89.53.53 0 0 0 .03-.67L11.4 9.41l3.06-.76a.52.52 0 0 0 .32-.58" fill-rule="evenodd"></path></svg></button></span></span>
            </span><em class="bx">You can reach all Python scripts relative to this on my </em><a href="https://github.com/abhashpanwar/used-car-price-prediction" class="cl dy km kn ko kp" target="_blank" rel="noopener nofollow">github page</a><em class="bx">. If you are interested, you can also find the scripts used for data cleaning and data visualization for this study in the same repository. And the project is also deployed using django on heroku.</em>
            <a
                href="https://abhash-car-price-prediction.herokuapp.com" class="cl dy km kn ko kp" target="_blank" rel="noopener nofollow"><em class="bx">View Deployment</em></a>
        </p>
    </blockquote>
